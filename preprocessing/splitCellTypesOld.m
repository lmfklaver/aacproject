function [pyrs, ints, aacs] = splitCellTypesOld(basepath)
% This function
%
%   USAGE 
%
...
%
%   HISTORY
%   2020/12/11 deprecated? Redundant. Keeping around for backwards compatibity sake
%% 
...
[baserate, stimrate] = getRatesTrialsBaseStim(spikes, optoStim.timestamps, 'timwin', [-0.5 0.5],'binSize', 0.001,'stimWin',0.05);
