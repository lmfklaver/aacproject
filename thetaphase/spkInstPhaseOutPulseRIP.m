function [spkInstPhaseStruct]=spkInstPhaseOutPulseRIP(basepath, icell)
...
%preference
freqband = [120 250]; % [5 10] % average phase is calculated over the entire [5 10]
...
[status, interval] = cellfun(@(a) InIntervals(a, ripples.timestamps),spikes.nopulse, 'uni',false);           
for iUnit = icell;
